...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FKawaiiPhysics_ExternalForce_Wind_Statics::NewProp_ForceRateByBoneLengthRate = { "ForceRateByBoneLengthRate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0x0000, STRUCT_OFFSET(FKawaiiPhysics_ExternalForce_Wind, ForceRateByBoneLengthRate), Z_Construct_UScriptStruct_FRuntimeFloatCurve, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_ForceRateByBoneLengthRate_MetaData), NewProp_ForceRateByBoneLengthRate_MetaData) }; // 2539251863
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FKawaiiPhysics_ExternalForce_Wind_Statics::NewProp_WindDirectionNoiseAngle = { "WindDirectionNoiseAngle", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0x0000, STRUCT_OFFSET(FKawaiiPhysics_ExternalForce_Wind, WindDirectionNoiseAngle), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WindDirectionNoiseAngle_MetaData), NewProp_WindDirectionNoiseAngle_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FKawaiiPhysics_ExternalForce_Wind_Statics::NewProp_World = { "World", nullptr, (EPropertyFlags)0x0144000000000000, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0x0000, STRUCT_OFFSET(FKawaiiPhysics_ExternalForce_Wind, World), Z_Construct_UClass_UWorld_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_World_MetaData), NewProp_World_MetaData) };
...
// ********** Begin Registration *******************************************************************
struct Z_CompiledInDeferFile_FID_Users_Michael_Taulli_Desktop_Challenge_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_ExternalForces_KawaiiPhysicsExternalForce_Wind_h__Script_KawaiiPhysics_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FKawaiiPhysics_ExternalForce_Wind::StaticStruct, Z_Construct_UScriptStruct_FKawaiiPhysics_ExternalForce_Wind_Statics::NewStructOps, TEXT("KawaiiPhysics_ExternalForce_Wind"),&Z_Registration_Info_UScriptStruct_FKawaiiPhysics_ExternalForce_Wind, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FKawaiiPhysics_ExternalForce_Wind), 2134081113U) },
	};
}; // Z_CompiledInDeferFile_FID_Users_Michael_Taulli_Desktop_Challenge_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_ExternalForces_KawaiiPhysicsExternalForce_Wind_h__Script_KawaiiPhysics_Statics 
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Michael_Taulli_Desktop_Challenge_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_ExternalForces_KawaiiPhysicsExternalForce_Wind_h__Script_KawaiiPhysics_979605310{
	TEXT("/Script/KawaiiPhysics"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_Michael_Taulli_Desktop_Challenge_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_ExternalForces_KawaiiPhysicsExternalForce_Wind_h__Script_KawaiiPhysics_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Michael_Taulli_Desktop_Challenge_Plugins_KawaiiPhysics_Source_KawaiiPhysics_Public_ExternalForces_KawaiiPhysicsExternalForce_Wind_h__Script_KawaiiPhysics_Statics::ScriptStructInfo),
	nullptr, 0,
};
// ********** End Registration *********************************************************************
